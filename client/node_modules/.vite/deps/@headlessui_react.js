import {
  ...
  shift,
  size
} from "./chunk-KQBX7KR3.js";
import {
  require_react_dom
} from "./chunk-UMBSSVY5.js";
import {
  require_react
    ...
    this.getMeasurements = memo(
      ...
      ({ count: count2, paddingStart, scrollMargin, getItemKey, enabled }, itemSizeCache) => {
        ...
        for (let i15 = min2; i15 < count2; i15++) {
          ...
          const size3 = typeof measuredSize === "number" ? measuredSize : this.options.estimateSize(i15);
    ...
    this.getOffsetForAlignment = (toOffset, align) => {
      ...
      if (align === "auto") {
        if (toOffset <= scrollOffset) {
          align = "start";
        } else if (toOffset >= scrollOffset + size3) {
          align = "end";
        } else {
          align = "start";
        }
...
function Me({ children: e8, enabled: t11 = true }) {
  ...
  let { refs: b9, floatingStyles: w11, context: g6 } = useFloating2({ open: i15, placement: a20 === "selection" ? p6 === "center" ? "bottom" : `bottom-${p6}` : p6 === "center" ? `${a20}` : `${a20}-${p6}`, strategy: "absolute", transform: false, middleware: [offset2({ mainAxis: a20 === "selection" ? 0 : E12, crossAxis: v4 }), shift2({ padding: c15 }), a20 !== "selection" && flip2({ padding: c15 }), a20 === "selection" && P7 ? inner({ ...P7, padding: c15, overflowRef: u17, offset: r18, minItemsVisible: q, referenceOverflowThreshold: c15, onFallbackChange(h7) {
    var O7, W5;
    if (!h7) return;
  ...
  } }) : null, size2({ padding: c15, apply({ availableWidth: h7, availableHeight: d13, elements: T10 }) {
